...
Capabilities="//a[contains(text(),'Capabilities')]"
Capability_UID_textbox="//input[@id='form1:inputText3']"
Datatype_Name_textbox="//input[@id='form1:inputText16']"
search_capability="//a[@id='form1:commandButton12']//img"
editFilebrokerSettingsButton="//a[@id='form1:table1:0:editFilebrokerSettingsButton']"
add_filebroker_btn="//td[3]//a[1]//img[1]"


Source_Channel	="//select[@id='_idJsp4:_idJsp8']"
Destination_Channel="//select[@id='_idJsp4:_idJsp39']"

Source_Channel_text	="//*[contains(text(),'DC4 - Read or write files from/to DC4')]"
Destination_Channel_text="//*[contains(text(),'File - Read or write files from/to internal comms server')]"



Status="//select[@id='_idJsp4:_idJsp70']"
Status_text="//*[contains(text(),'Active')]"
continue_btn="//td//td[1]//a[1]//img[1]"

ArchiveDirectory_fito="//input[@id='_idJsp4:_idJsp57:0:_idJsp61']"
ArchiveDirectory_fifrom="//input[@id='_idJsp4:_idJsp57:0:_idJsp61']"
Directory_fito="//input[@id='_idJsp4:_idJsp57:1:_idJsp61']"
Directory_fifrom="//input[@id='_idJsp4:_idJsp38:0:_idJsp42']"
FilenameMacro_fito="//input[@id='_idJsp4:_idJsp57:2:_idJsp61']"
FileSpecification="//input[@id='_idJsp4:_idJsp38:1:_idJsp42']"
Save_Changes_btn="//*[contains(@title,'Save Changes')]"
